...
const { generateMessage, generateLocationUrlMessage } = require('./utils/message');
...
io.on('connection', (socket) => {
    ...
    socket.on('createLocationMessage', (coords) => {
        console.log(coords);
        io.emit('newLocation', generateLocationUrlMessage('Admin', coords.latitude, coords.longitude));
    })
